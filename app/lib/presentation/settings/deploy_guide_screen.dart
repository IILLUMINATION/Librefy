      ...
      body: ListView(
        ...
        children: const [
          ...
          _Step(
            ...
            body:
                'Clone the public repo. Everything needed for a one-binary deployment '
                "is in the backend/ folder.",
            commands: [
              _Cmd('git clone https://github.com/onlysq/librefy.git'),
          ...
          _Step(
            ...
            commands: [
              ...
              _Cmd(
                ...
                '  mkdir -p /var/lib/librefy && chown librefy:librefy /var/lib/librefy\n'
          ...
          _Step(
            ...
            body:
                'The admin API stays disabled until you set this. Generate '
                'a strong random value and save it — you will need it for '
                'the web UI.',
            commands: [
          ...
          _Step(
            ...
            body:
                ...
                'YOUR_TOKEN with the value from step 4.',
            commands: [
              _Cmd(
                'cat <<EOF | sudo tee /etc/systemd/system/librefyd.service\n'
                '[Unit]\n'
          ...
          _Step(
            ...
            body:
                'Open Settings → Backend URL and paste:',
            commands: [
              _Cmd('http://YOUR_VPS_IP:8088'),
            ],
            note:
                'For production you should sit librefyd behind nginx with '
                'a Let\'s Encrypt certificate. See docs/DEPLOY.md in the '
                'repo for the full HTTPS setup.',
          ),
          _Step(
            number: 7,
            ...
            commands: [
              _Cmd('http://YOUR_VPS_IP:8088/admin/'),
            ],
            note:
                'You can create tracks, build playlists, bulk-import JSON '
                'and export the whole catalog back to a seed file for git.',
          ),
          SizedBox(height: 24),
          _LegalReminder(),
        ],
